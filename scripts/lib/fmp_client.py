#!/usr/bin/env python3
"""
Shared FMP API client for trading skills.

Provides rate-limited access to Financial Modeling Prep API endpoints with:
- Rate limiting (0.3s between requests)
- Automatic retry on 429 errors
- Session caching for duplicate requests
- API call budget enforcement
- Stable→v3 endpoint fallback for historical EOD
"""
