...
echo "Cron schedule is encoded in UTC for Bangkok market hours because this VM runs UTC."
echo "================================================"
...
# The VM runs Etc/UTC and the installed cron implementation has not applied
# CRON_TZ consistently. Encode the intended Bangkok times explicitly:
# TH 10:00-17:00 ICT -> 03:00-10:00 UTC
# US 20:30/21:00/21:30 ICT -> 13:30/14:00/14:30 UTC
