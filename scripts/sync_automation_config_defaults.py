...
FORCE_TEMPLATE_PATHS = (
    ...
    "auto_paper.use_dynamic_atr",
    "auto_paper.atr_multiplier",
    "auto_paper.stop_pct_min",
    "auto_paper.stop_pct_cap",
    "auto_paper.use_sector_filter",
    "auto_paper.min_sector_relative_return",
    "auto_paper.use_scale_out",
    "auto_paper.scale_out_r",
    "auto_paper.scale_out_fraction",
    "auto_paper.early_fakeout_enabled",
    "auto_paper.early_fakeout_vol_ratio",
    "auto_paper.early_fakeout_max_mfe_r",
    ...
    "auto_paper.source_rules.thai-swing-dip.use_dynamic_atr",
    "auto_paper.source_rules.thai-swing-dip.atr_multiplier",
    "auto_paper.source_rules.thai-swing-dip.early_fakeout_enabled",
    "auto_paper.source_rules.thai-swing-dip.early_fakeout_vol_ratio",
    "auto_paper.source_rules.thai-swing-dip.early_fakeout_max_mfe_r",
    ...
    "auto_paper.source_rules.thai-swing-momentum.use_dynamic_atr",
    "auto_paper.source_rules.thai-swing-momentum.atr_multiplier",
    "auto_paper.source_rules.thai-swing-momentum.early_fakeout_enabled",
    "auto_paper.source_rules.thai-swing-momentum.early_fakeout_vol_ratio",
    "auto_paper.source_rules.thai-swing-momentum.early_fakeout_max_mfe_r",
    ...
    "auto_paper.source_rules.vcp-screener.use_dynamic_atr",
    "auto_paper.source_rules.vcp-screener.atr_multiplier",
    "auto_paper.source_rules.vcp-screener.early_fakeout_enabled",
    "auto_paper.source_rules.vcp-screener.early_fakeout_vol_ratio",
    "auto_paper.source_rules.vcp-screener.early_fakeout_max_mfe_r",
