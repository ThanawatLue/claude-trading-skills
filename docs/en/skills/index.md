...
| [Market Breadth Analyzer]({{ '/en/skills/market-breadth-analyzer/' | relative_url }}) ★ | Quantifies market breadth health using data-driven 6-component scoring | <span class="badge badge-free">No API</span> |
...
| [Paper Trade Simulator]({{ '/en/skills/paper-trade-simulator/' | relative_url }}) | Simulate trades without real money to test strategy and emotional discipline | <span class="badge badge-free">No API</span> |
...
| [Portfolio Manager]({{ '/en/skills/portfolio-manager/' | relative_url }}) | Comprehensive portfolio analysis using direct Alpaca API integration to fetch holdings and positions, then analyze as... | <span class="badge badge-api">Alpaca Required</span> |
...
| [Scenario Analyzer]({{ '/en/skills/scenario-analyzer/' | relative_url }}) | Analyze 18-month scenarios from news headlines | <span class="badge badge-free">No API</span> |
...
| [Skill Idea Miner]({{ '/en/skills/skill-idea-miner/' | relative_url }}) | Mine Gemini Code session logs for skill idea candidates | <span class="badge badge-free">No API</span> |
| [Skill Integration Tester]({{ '/en/skills/skill-integration-tester/' | relative_url }}) | Validate multi-skill workflows defined in GEMINI | <span class="badge badge-free">No API</span> |
...
| [Thai Breadth Analyzer]({{ '/en/skills/thai-breadth-analyzer/' | relative_url }}) | Compute fast market-breadth snapshot for the Thai SET market via TradingView Screener — % above SMA50/200, advance-de... | <span class="badge badge-free">No API</span> |
| [Thai Dividend Screener]({{ '/en/skills/thai-dividend-screener/' | relative_url }}) | Screen Thai SET stocks for high-quality dividend income opportunities | <span class="badge badge-free">No API</span> |
| [Thai Sector Heatmap]({{ '/en/skills/thai-sector-heatmap/' | relative_url }}) | Generate a sector-rotation heatmap for the Thai SET market using TradingView Screener data | <span class="badge badge-free">No API</span> |
| [Thai Watchlist Builder]({{ '/en/skills/thai-watchlist-builder/' | relative_url }}) | Auto-build 4 curated watchlists from the Thai SET market (Growth, Value, Momentum, Mean-Reversion) using TradingView ... | <span class="badge badge-free">No API</span> |
...
| [US Breadth Analyzer Tv]({{ '/en/skills/us-breadth-analyzer-tv/' | relative_url }}) | Compute fast market-breadth snapshot for the US market via TradingView Screener — % above SMA50/200, advance-decline,... | <span class="badge badge-free">No API</span> |
| [US Dividend Screener]({{ '/en/skills/us-dividend-screener/' | relative_url }}) | Screen US stocks for high-quality dividend income opportunities | <span class="badge badge-free">No API</span> |
...
| [US Sector Heatmap]({{ '/en/skills/us-sector-heatmap/' | relative_url }}) | Generate a sector-rotation heatmap for the US market using TradingView Screener data | <span class="badge badge-free">No API</span> |
...
| [US Watchlist Builder]({{ '/en/skills/us-watchlist-builder/' | relative_url }}) | Auto-build 4 curated watchlists from the US market (Growth, Value, Momentum, Mean-Reversion) using TradingView Screen... | <span class="badge badge-free">No API</span> |
...
| [VCP Screener]({{ '/en/skills/vcp-screener/' | relative_url }}) ★ | Screen S&P 500 (US) or SET50 (Thai) stocks for Mark Minervini's Volatility Contraction Pattern (VCP) | <span class="badge badge-api">FMP Required</span> |
